...
namespace RobotsVSDinosaurs
{
    class Herd
    {
        ...
        public Herd ()
	    {
            ...
            Dinosaur dinosaurOne = new Dinosaur("T-Rex", 100, 100, 100);
            Dinosaur dinosaurTwo = new Dinosaur("Raptor", 100, 100, 100);
            Dinosaur dinosaurThree = new Dinosaur("Tall", 100, 100, 100);
